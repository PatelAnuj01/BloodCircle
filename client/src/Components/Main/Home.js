...
const Home = () => {
    ...
    const temp2 = [
        { 
            title: "Registration", 
            img: g1,
            description: "The first step in the donation process is registration. You will fill out forms with your personal details and medical history."
        },
        { 
            title: "Seeing", 
            img: g2,
            description: "A quick physical examination will be performed to ensure you're healthy enough to donate blood."
        },
        { 
            title: "Donation", 
            img: g3,
            description: "During this step, blood is drawn from your body through a sterile needle and collected into a bag."
        },
        { 
            title: "Save Life", 
            img: g4,
            description: "After donation, your blood is processed and sent to hospitals to help those in need, saving lives."
        }
    ];
    ...
    return (
        <div className="dark:text-white-900">
            ...
            <div className='w-full bg-blood text-white-900 h-max text-sm text-center font-bold'>
                <code>BloodCircle @ {new Date().getFullYear()} || Made with ❤️</code>
            </div>
        </div>
    );
}
